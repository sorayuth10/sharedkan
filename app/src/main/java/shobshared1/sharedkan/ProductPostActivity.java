                    ...
                    if (task.isSuccessful()) {
                        ...
                        mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                newPost.child("Category").setValue("Product");
                                ...
                                newPost.child("username").setValue(dataSnapshot.child("name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            startActivity(new Intent(ProductPostActivity.this, HomeActivity.class));
                                        }
                                        else{
                        ...
                        Toast.makeText(ProductPostActivity.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
