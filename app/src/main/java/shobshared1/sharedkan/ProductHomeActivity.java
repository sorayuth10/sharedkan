...
public class ProductHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() == null){
                    Intent loginIntent = new Intent(ProductHomeActivity.this, LoginActivity.class);
                    /*
        ...
        mDatabaseProduct = FirebaseDatabase.getInstance().getReference().child("Blog");
        mQueryCurrentUser = mDatabaseProduct.orderByChild("Category").equalTo("Product"); //Query all blogs for current user
            ...
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent detailsBlogIntent = new Intent(ProductHomeActivity.this, BlogDetailsActivity.class);
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (!dataSnapshot.hasChild(user_id)) { //If child does notexist
                        Intent mainIntent = new Intent(ProductHomeActivity.this, SetupActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_chat) {
            startActivity(new Intent(ProductHomeActivity.this, ChatActivity.class));
        }
        if(item.getItemId() == R.id.action_food_post){
            startActivity(new Intent(ProductHomeActivity.this, FoodHomeActivity.class));
        }
        ...
        if(item.getItemId() == R.id.action_settings) {
            startActivity(new Intent(ProductHomeActivity.this, SetupEditActivity.class));
        }
