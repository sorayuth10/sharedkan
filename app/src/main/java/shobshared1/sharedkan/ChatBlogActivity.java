...
public class ChatBlogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null) {
            startActivity(new Intent(ChatBlogActivity.this, LoginActivity.class));
        }
            ...
            if (message.isEmpty()) {
                ...
                if (FirebaseAuth.getInstance().getCurrentUser().getPhotoUrl() != null) {
                    FirebaseDatabase.getInstance()
                            .getReference()
                            .child("Blog").child(key).child("chat")
                            .push()
                    ...
                    // Clear the input
                } else {mDatabase.child("Users").child(mCurrentUser.getUid()).addValueEventListener(new ValueEventListener() {
                    ...
                    mDatabase.child("Blog").child(key).child("chat")
                            .push()
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<ChatMessage, ChatViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<ChatMessage, ChatViewHolder>(
                        ...
                        dbChatRef.child(key).child("chat")) {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_home) {
            startActivity(new Intent(ChatblogActivity.this, HomeActivity.class));
        }
        if(item.getItemId() == R.id.action_food_post){
            startActivity(new Intent(ChatblogActivity.this, FoodHomeActivity.class));
        }
        if(item.getItemId() == R.id.action_product_post){
            startActivity(new Intent(ChatblogActivity.this, ProductHomeActivity.class));
        }
        if(item.getItemId() == R.id.action_settings) {
            startActivity(new Intent(ChatBlogActivity.this, SetupEditActivity.class));
        }
