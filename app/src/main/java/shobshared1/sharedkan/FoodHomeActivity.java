...
public class FoodHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() == null){
                    Intent loginIntent = new Intent(FoodHomeActivity.this, LoginActivity.class);
                    /*
        ...
        mDatabaseFood = FirebaseDatabase.getInstance().getReference().child("Blog");
        mQueryCurrentUser = mDatabaseFood.orderByChild("Category").equalTo("Food"); //Query all blogs for current user
            ...
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent detailsBlogIntent = new Intent(FoodHomeActivity.this, BlogDetailsActivity.class);
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (!dataSnapshot.hasChild(user_id)) { //If child does notexist
                        Intent mainIntent = new Intent(FoodHomeActivity.this, SetupActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_chat) {
            startActivity(new Intent(FoodHomeActivity.this, ChatActivity.class));
        }
        ...
        if(item.getItemId() == R.id.action_product_post){
            startActivity(new Intent(FoodHomeActivity.this, ProductHomeActivity.class));
        }
        if(item.getItemId() == R.id.action_settings) {
            startActivity(new Intent(FoodHomeActivity.this, SetupEditActivity.class));
        }
